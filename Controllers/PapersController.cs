...
using ResearchGate.datafunctionfolder;
...
namespace ResearchGate.Controllers
{
    public class PapersController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            var db2 = new datafunction();
            ViewBag.like = db2.GetLikesCount(id);
            ViewBag.Dislike = db2.GetDislikesCount(id);
            ViewBag.AllUserlikedislike = db2.GetAllUsers(id);
        ...
        {
            var db2 = new datafunction(); // object of the class that contains the methods for the like logic
            var result = db2.Like(id, status); // calling the Like function that is in the class that contains the methods for the like logic 
